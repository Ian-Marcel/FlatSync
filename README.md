...
```sh
curl -fsSL4 https://from.ianmarcel.dev/install/flatsync | env bash
```

To test the experimental version use:

```sh
curl -fsSL4 https://from.ianmarcel.dev/install/flatsync | EXPERIMENTAL=true env bash
```
...
```sh
curl -fsSL4 https://from.ianmarcel.dev/uninstall/flatsync | env sh
```
